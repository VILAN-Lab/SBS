...
class BaseModel_repair(nn.Module):
    def __init__(self, w_emb, q_emb, v_att, q_net, v_net, classifier):
        super(BaseModel_repair, self).__init__()
        self.w_emb = w_emb
        self.q_emb = q_emb
        # self.v_att = v_att
        self.q_net = q_net
...
def build_baseline0_repair(dataset, num_hid):
    ...
    classifier = SimpleClassifier(
        num_hid, num_hid * 2, 2410, 0.5)
    return BaseModel_repair(w_emb, q_emb, v_att, q_net, v_net, classifier)
