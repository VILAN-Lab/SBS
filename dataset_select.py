...
class VQAFeatureDataset_Select(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.image_to_fe is not None:
            ...
            features = \
            torch.load(open('data/rcnn_feature/' + str(entry["image_id"]) + '.pth', 'rb'), encoding='iso-8859-1')['image_feature']
            features = torch.from_numpy(features).view(36, 2048)
