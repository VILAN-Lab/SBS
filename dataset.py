...
class VQAFeatureDataset(Dataset):
            ...
            for entry in tqdm(self.entries, ncols=100, desc="caching-features"):
                ...
                if img_id not in image_to_fe:
                    if use_hdf5:
                        ...
                        fe = torch.load(open('data/rcnn_feature/'+str(img_id)+'.pth', 'rb'), encoding='iso-8859-1')['image_feature']
    ...
    def __getitem__(self, index):
        ...
        if self.name=='train':
            ...
            if "bias" in entry:
                return features, ques, target, entry["bias"], train_hint,\
                       type_mask, notype_mask, ques_mask
